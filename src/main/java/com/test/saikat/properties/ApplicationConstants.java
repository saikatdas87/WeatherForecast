...
/**
 * A class to hold application constant values
 * <p>
 * Created by Saikat Das .
 */
public class ApplicationConstants {

    public static final String WEATHER_API_READ_ERROR = "The weather information can not be displayed now due to network or configuration error";
